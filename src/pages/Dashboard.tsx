...
export default function Dashboard() {
  ...
  const statusData = [
    { name: t.dashboard.validated, value: 1245, color: "hsl(142, 71%, 45%)" },
    { name: t.dashboard.pending, value: 342, color: "hsl(38, 92%, 50%)" },
    { name: t.dashboard.rejected, value: 89, color: "hsl(0, 72%, 51%)" },
    { name: t.dashboard.submitted, value: 1156, color: "hsl(220, 70%, 50%)" },
  ];
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4">
        <MetricCard title={t.dashboard.docsProcessed} value="1,676" change={t.dashboard.changeDocsProcessed} changeType="positive" icon={FileStack} />
        <MetricCard title={t.dashboard.autoValidated} value="1,245" change={t.dashboard.changeAutoValidated} changeType="positive" icon={CheckCircle2} iconColor="bg-success/10" />
        <MetricCard title={t.dashboard.pendingValidation} value="342" change={t.dashboard.changePending} changeType="negative" icon={Clock} iconColor="bg-warning/10" />
        <MetricCard title={t.dashboard.rejected} value="89" change={t.dashboard.changeRejected} changeType="positive" icon={XCircle} iconColor="bg-destructive/10" />
        <MetricCard title={t.dashboard.submittedToClients} value="1,156" change={t.dashboard.changeSubmitted} changeType="positive" icon={Send} />
        ...
        <MetricCard title={t.dashboard.blockedWorkers} value="7" change={t.dashboard.changeBlocked} changeType="negative" icon={Ban} iconColor="bg-destructive/10" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-4">
        ...
        <div className="bg-card rounded-lg border p-4 md:p-5">
          ...
          <h3 className="text-sm font-semibold text-foreground mt-6 mb-3">{t.dashboard.recentRejections}</h3>
