  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="flex items-center gap-2 px-4 py-2 text-xs font-medium rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">
            ...
            {rules.map((rule) => (
              <tr key={rule.id} className="border-b last:border-0 table-row-interactive">
                ...
                <td className="p-3 text-foreground flex items-center gap-1.5">
                  <ShieldCheck className="w-3 h-3 text-primary" />{rule.docType}
                </td>
                <td className="p-3">
